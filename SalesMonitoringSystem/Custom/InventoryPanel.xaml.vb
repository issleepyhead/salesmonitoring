...
Public Class InventoryPanel
    ...
    Private _tableAdapter As New sgsmsdbTableAdapters.viewtblinventoryTableAdapter
    Private _dataTable As New sgsmsdb.viewtblinventoryDataTable
    ...
    Public Sub Update() Implements IObserverPanel.Update
        ...
        InventoryRecordsDataGrid.ItemsSource = _dataTable.DefaultView
    End Sub
End Class
